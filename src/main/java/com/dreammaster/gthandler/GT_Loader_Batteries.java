...
public class GT_Loader_Batteries
{
	...
	private void registerBatteries()
	{
		...
		CustomItemList.BatteryHull_UV_Large.set(GT.addItem(568, "Extra Large Naquadria Battery (Empty)", "An extra large empty UV Energy Storage", new Object[] { new ItemData(Materials.Oriharukon, OrePrefixes.plate.mMaterialAmount * 18L), new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 128L), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 128L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 128L) }));
		...
		CustomItemList.BatteryHull_UHV_Large.set(GT.addItem(567, "Extra Large Neutronium Battery (Empty)", "An empty Extra Large UHV Energy Storage", new Object[] { new ItemData(Materials.CosmicNeutronium, OrePrefixes.plate.mMaterialAmount * 24L), new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 256L), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 256L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 256L) }));
		...
		GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt08, Materials.Draconium, 16L),
				GT_OreDictUnificator.get(OrePrefixes.plate, Materials.CosmicNeutronium, 48L), Materials.Polybenzimidazole.getMolten(1152L),
		...
		CustomItemList.BatteryHull_UV_Large_Full.set(GT.addItem(tLastID = 569, "Extra Large Naquadria Battery", "Fill this UV storage to have way less electricity (reusable)\"", new Object[]{new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 128L), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 128L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 128L)}));
